...
class App extends React.Component {
    ...
    initialisieren() {
        ...
        let aufgabe1 = montagDeutsch.artikelHinzufuegen("Schreibübung 1")
        montagDeutsch.artikelHinzufuegen("Hexentext lesen")
        let montagMathe = Modell.gruppeHinzufuegen("Montag Mathe")
        let aufgabe2 = montagMathe.artikelHinzufuegen("+ und -")
        montagMathe.artikelHinzufuegen("Zahlen Suchspiel")
        let dienstagDeutsch = Modell.gruppeHinzufuegen("Dienstag Deutsch")
        let aufgabe3 = dienstagDeutsch.artikelHinzufuegen("Schreibübung 2")
        let aufgabe4 = dienstagDeutsch.artikelHinzufuegen("Hexentext lesen")
